# ![thumbnail](images/icon.png) Gomez Automated Tracker <br/> ┃ A PopTracker pack for FezAP
...
## Requirements
[PopTracker v0.26.2 or greater](https://github.com/black-sliver/PopTracker/releases)
